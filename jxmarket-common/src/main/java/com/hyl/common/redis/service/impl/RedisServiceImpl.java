package com.hyl.common.redis.service.impl;
...
public class RedisServiceImpl implements RedisService {
    ...
    public void clearLoginCacheData(JwtData jwtData) {
        ...
        keys.add(CacheConstant.OAUTH_USER_TOKEN_KEY + jwtData.getAccount());
        keys.add(CacheConstant.OAUTH_USER_INFO_KEY + jwtData.getAccount());
        del(keys);
    }
}
