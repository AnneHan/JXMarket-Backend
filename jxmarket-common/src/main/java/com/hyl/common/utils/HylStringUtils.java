...
public class HylStringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static String appendURIParam(String url, String name, String value) {
        url += (url.indexOf('?') == -1 ? '?' : '&');
        url += UriEncoder.encode(name) + '=' + UriEncoder.encode(value);
        return url;
    }
     ...
     *
     * @param nonCheckCodeBankCard 非银行卡检查代码
     * @return char
     */
    ...
    public static String stripXss(String value) {
        if (HylStringUtils.isNotBlank(value)) {
    ...
    public static void main(String[] args) {
        System.out.println(HylStringUtils.matchDomain("515608851@qq.com"));
        System.out.println(HylStringUtils.matchDomain("www.qq.com"));
        System.out.println(HylStringUtils.matchDomain("qq.com"));
        System.out.println(HylStringUtils.matchIp("qq.com"));
        System.out.println(HylStringUtils.matchIp("192.168.0.1"));
