...
public class WebUtils {
     ...
     * 静态文件后缀
     */
    private final static String[] staticFiles = HylStringUtils.split(staticSuffix, ",");
    ...
    public static Map<String, Object> getParametersWith(final HttpServletRequest request, String prefix) {
    ...
    public static Map<String, String> getParameterMap(final HttpServletRequest request) {
        ...
        if (contentType != null && contentType.contains(MediaType.MULTIPART_FORM_DATA_VALUE)) {
            // form-data表单
            MultipartResolver multipartResolver = ApplicationUtils.getBean(MultipartResolver.class);
            assert multipartResolver != null;
            ...
            if (HylStringUtils.isNotBlank(body)) {
                try {
    ...
    private static Map<String, String> conventMap(Map<String, String[]> map) {
        Map<String, String> returnMap = Maps.newHashMap();
        // 返回值Map
    ...
    public static boolean isStaticFile(String uri) {
        return HylStringUtils.endsWithAny(uri, staticFiles) && !HylStringUtils.endsWithAny(uri, new String[]{urlSuffix})
                && !HylStringUtils.endsWithAny(uri, new String[]{".jsp"}) && !HylStringUtils.endsWithAny(uri, new String[]{".java"});
    }
